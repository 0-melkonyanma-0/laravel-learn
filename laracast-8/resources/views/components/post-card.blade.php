...
<article
    {{ $attributes->merge([
        'class' => "transition-colors duration-300 hover:bg-gray-100 border
                            border-black border-opacity-0 hover:border-opacity-5 rounded-xl mt-2 me-2",
    ]) }}>
    <div class="py-6 px-5">
        <div>
        ...
        <div class="mt-8 flex flex-col justify-between">
            <header>
                <div class="space-x-2">
                    ...
                    <a href="#"
                        class="px-3 py-1 border border-red-300 rounded-full
                                       text-red-300 text-xs uppercase font-semibold"
